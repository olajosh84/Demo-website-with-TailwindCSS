    ...
    return (
        <div className="w-full h-screen relative">
            ...
            <div className="bg-black w-[90vw] px-4 py-8 text-center bg-opacity-40 absolute top-[30%] left-1/2 -translate-x-1/2 -translate-y-1/2 rounded-xl border-t-4 border-t-sky-800">
                ...
                <Link to="/about">
                    <button className={`uppercase bg-transparent border-2 border-white rounded-full px-4 py-2 mt-8 text-white transition-all hover:bg-slate-900 ${animateBtn ? 'animateSlideBtn' : ''}`} onAnimationEnd={() => dispatch(endAnimation("btn"))}>read more</button>
                </Link>
            </div>
