export default function Contact(){
    return (
        <section className="section-basics">
            <h1 className="text-xl uppercase text-slate-800 mb-3">contact us</h1>
                ...
                <article className="bg-white shadow-2xl flex flex-col gap-8 p-4 md:flex-row">
                    ...
                    <form className="space-y-8 w-full mb-4">
                        ...
                        <button className="shadow-lg shadow-slate-400 block border-2 border-slate-500 rounded-full py-1 capitalize px-4 bg-transparent text-center hover:bg-sky-600 hover:text-white hover:border-blue-500"  type="submit">submit</button>
                    </form>
